...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Add a Cloud Domain</h1>
</div>
	...
	<div class="card-body">
		<?php echo form_open('/cloud_domain/add', array('class'=>'user')) ?>
			<div class="form-group row">
				<label for="staticEmail" class="offset-2 col-sm-2 col-form-label">DNS Zone</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label for="inputPassword" class="offset-2 col-sm-2 col-form-label">Cloud Domain</label>
				<div class="col-sm-6">
